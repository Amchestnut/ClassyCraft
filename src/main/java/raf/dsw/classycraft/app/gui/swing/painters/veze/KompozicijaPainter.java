...
public class KompozicijaPainter extends ConnectionPainter{
    public KompozicijaPainter(DiagramElement interclassOD, DiagramElement interclassDO, DiagramElement diagramElement) {
        super(interclassOD, interclassDO, diagramElement);
    }
}
